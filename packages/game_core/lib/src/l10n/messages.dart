...
const Map<String, Map<String, String>> _messages = {
  'de': {
    ...
    'cannotTransferTile': 'Das Feld kann nicht übertragen werden !',
    'cannotTransferCapital': 'Die Hauptstadt kann nicht übertragen werden !',
    'tileHasTroops': 'Auf dem Feld stehen Truppen !',
    'tileHasShips': 'Auf dem Feld liegt ein Schiff !',
    ...
    'stanceTargetOnLand': 'Das Marschziel muss ein Landfeld sein !',
  ...
  'en': {
    ...
    'cannotTransferTile': 'This tile cannot be transferred!',
    'cannotTransferCapital': 'The capital cannot be transferred!',
    'tileHasTroops': 'Troops are stationed on this tile!',
    'tileHasShips': 'A ship is on this tile!',
    ...
    'stanceTargetOnLand': 'The march target must be a land tile!',
