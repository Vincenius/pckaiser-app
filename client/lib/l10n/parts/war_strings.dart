...
const Map<String, String> warDe = {
  ...
  'war.stanceTargetLabel': 'Marschziel: ',
  'war.stanceTargetSeat': 'gegnerischer Königssitz',
  'war.stanceTargetTile': 'Feld ({x}, {y})',
  'war.stanceTargetPick': 'Auf Karte wählen',
  'war.stanceTargetReset': 'Zurücksetzen',
  'war.stanceTargetHint': 'Marschziel für „{name}" antippen',
...
const Map<String, String> warEn = {
  ...
  'war.stanceTargetLabel': 'March target: ',
  'war.stanceTargetSeat': 'enemy royal seat',
  'war.stanceTargetTile': 'tile ({x}, {y})',
  'war.stanceTargetPick': 'Pick on map',
  'war.stanceTargetReset': 'Reset',
  'war.stanceTargetHint': 'Tap the march target for "{name}"',
